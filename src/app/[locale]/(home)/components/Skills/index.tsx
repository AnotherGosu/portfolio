  ...
  return (
    <section>
      ...
      <div className="grid-rows-auto grid grid-cols-1 gap-6 md:grid-cols-2">
        <Card
          title={dict.skills.card_1.title}
        ...
        <Card
          title={dict.skills.card_2.title}
        ...
        <Card
          title={dict.skills.card_3.title}
        ...
        <Card
          title={dict.skills.card_4.title}
          icon={<AcademicCapIcon className="size-7" />}
          className="bg-indigo-50 shadow-md"
        >
          <ul className="list-disc pl-4 leading-loose">
            <li>{dict.skills.card_4.item_1}</li>
            <li>{dict.skills.card_4.item_2}</li>
          </ul>
        </Card>
      </div>
    </section>
